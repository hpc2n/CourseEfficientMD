...
gmx tune_pme -mdrun "gmx mdrun" -ntmpi $SLURM_NTASKS $mdargs  -dlb yes -s step4.1_equilibration.tpr -npstring none -nocheck -nolaunch -steps 10000 -resetstep 5000 -npme subset -max 0.5 -min 0.15 -rmax 1.6 -rmin 0.8 -ntpr 8
